...
template<> ALONE_API UScriptStruct* StaticStruct<FMapInfo>()
{
	...
	struct Z_CompiledInDeferFile_FID_Unreal_Projects_Alone_Source_Alone_AloneGameInstance_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_Alone_Source_Alone_AloneGameInstance_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_Alone_Source_Alone_AloneGameInstance_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_Alone_Source_Alone_AloneGameInstance_h_833788634(TEXT("/Script/Alone"),
		Z_CompiledInDeferFile_FID_Unreal_Projects_Alone_Source_Alone_AloneGameInstance_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Projects_Alone_Source_Alone_AloneGameInstance_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_Unreal_Projects_Alone_Source_Alone_AloneGameInstance_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Projects_Alone_Source_Alone_AloneGameInstance_h_Statics::ScriptStructInfo),
		nullptr, 0);
